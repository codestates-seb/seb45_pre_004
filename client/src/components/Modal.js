...
// setIsModal setter 함수를 통해 모달버튼을 클릭 시 닫히게 함
const Modal = ({ isModalOpen, setIsModal, modalText }) => {
  return (
    <ModalBackdrop isModalOpen={isModalOpen}>
      <ModalContainer isModalOpen={isModalOpen}>
        <ModalText>{modalText || "모달입니다."}</ModalText>
        <ModalButton
          onClick={setIsModal ? () => setIsModal(false) : () => {}}
